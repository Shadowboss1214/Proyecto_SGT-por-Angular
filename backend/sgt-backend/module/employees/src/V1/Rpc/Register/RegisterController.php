 ...
 * SHA1 (requerido por el servidor OAuth2 de Laminas) e inserta atómicamente en
 * `oauth_users` y `employees` de PostgreSQL.
 *
...
class RegisterController extends AbstractActionController
{
    ...
    public function registerAction()
    {
        ...
        // ✅ OAuth2 de Laminas verifica con SHA1, no bcrypt
